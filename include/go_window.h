...
public:
   ...
   */
  Window(unsigned width, unsigned height, std::string caption,
         bool fullscreen = false, double updateInterval = 16.666666);
...
private:
  ...
  void enqueueDraw(SDL_Texture *texture, SDL_Rect destRect, double angle,
                   float z, Uint8 alpha, SDL_Color color);
