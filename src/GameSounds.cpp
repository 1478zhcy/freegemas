...
void GameSounds::playSoundSelect() { mSfxSelect.play(0.3); }

void GameSounds::playSoundFall() { mSfxFall.play(0.3); }

void GameSounds::playSoundMatch1() { mSfxMatch1.play(0.25); }

void GameSounds::playSoundMatch2() { mSfxMatch2.play(0.25); }

void GameSounds::playSoundMatch3() { mSfxMatch3.play(0.25); }
